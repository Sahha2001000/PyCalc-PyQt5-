...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('calculator.ico'))
        font = QtGui.QFont()
        ...
        self.labelDisplay.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.btn__multiply.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.btn__multiply.setStyleSheet("background-color: rgb(134, 128, 134);\n"
                                         "font:500 40pt \"Segoe UI\";\n"
                                         "color: rgb(255, 170, 0);")
        self.btn__multiply.setAutoDefault(True)
        self.btn__multiply.setDefault(False)
        self.btn__multiply.setFlat(False)
        ...
        self.btn__calc.setGeometry(QtCore.QRect(162, 316, 80, 80))
        ...
        self.btn__clear.setGeometry(QtCore.QRect(81, 316, 81, 40))
        ...
        self.btn__dot = QtWidgets.QPushButton(self.centralwidget)
        self.btn__dot.setEnabled(True)
        self.btn__dot.setGeometry(QtCore.QRect(81, 357, 81, 39))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(28)
        font.setBold(True)
        font.setWeight(75)
        self.btn__dot.setFont(font)
        self.btn__dot.setStyleSheet("background-color: rgb(134, 128, 134);\n"
                                    "color: rgb(255, 170, 0);")
        self.btn__dot.setObjectName("btn__dot")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn__dot.setText(_translate("MainWindow", "."))
    ...
    def addFunctions(self):
        ...
        # Add dot btn for float number
        self.btn__dot.clicked.connect(lambda: self.writeNumber(self.btn__dot.text()))
        # FunctionPad btn
        # Cleared result
    ...
    def calculate(self):
        try:
            ...
            # Lock dot btn for float number
            self.btn__dot.setEnabled(False)
            # Lock OperandPad
    ...
    def clearDisplay(self):
        ...
        # Unlock dot btn for float number
        self.btn__dot.setEnabled(True)
        # Unlock OperandPad
